...
$stmt = $conn->prepare("INSERT IGNORE INTO item_actions(item,action,value,frequency,target,length,crit_chance,chance,stamina_cost,mana_cost) VALUES(?,?,?,?,?,?,?,?,?,?)");
...
if ($stmt->execute()){
	...
	Success("Added item",["itemaction"=>["id"=>$added_id]]);
}
